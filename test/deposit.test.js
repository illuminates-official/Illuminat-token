...
contract('Deposit', function (accounts) {
    ...
    describe('Base payment service functionality', async () => {
        beforeEach('init', async () => {
            ...
            await token.sendTokens([accounts[4], accounts[5]], [vs(100000), vs(100000)], {from: tokenOwner});
            ...
            await ps.replenishBalance(vs(100000), {from: accounts[4]});
            await ps.replenishBalance(vs(100000), {from: accounts[5]});
        });
